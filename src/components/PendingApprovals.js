              ...
              {loading ? (
                ...
                pending.map(m => (
                  <tr key={m._id} className="member-tr">
                    ...
                    <td>
                      <div style={{ fontWeight: '600', color: '#475569', fontSize: '0.9rem', whiteSpace: 'nowrap' }}>{m.department}</div>
                      <div style={{ fontSize: '0.72rem', color: '#ef4444', fontWeight: '600', textTransform: 'uppercase', marginTop: '4px', whiteSpace: 'nowrap' }}>መርጠው የተመዘገቡት፡ {m.serviceDepartment}</div>
                    </td>
